...
//Check if won
    if (guess === winningNum) {
        ...
        //Set message
        setMessage(`${winningNum} is correct, YOU WIN! Go to the bank, tell them my name and collect 100 dollars`, 'green');
    } else {
        //Wrong Number
        guessesLeft -= 1;
        ...
        //Set message
        setMessage(`Game Over loser. The correct number was ${winningNum}.Don't cry too much.`, 'red'); 
        } else{
